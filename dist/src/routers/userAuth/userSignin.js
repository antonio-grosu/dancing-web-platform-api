...
exports.userSigninRouter = void 0;
const express_1 = require("express");
const user_models_1 = require("../../models/user.models");
const authentication_1 = require("../../../common/src/services/authentication");
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const router = (0, express_1.Router)();
exports.userSigninRouter = router;
router.post("/api/user/auth/signin", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = jsonwebtoken_1.default.sign({ email, id: user._id, role: "user" }, process.env.JWT_KEY);
