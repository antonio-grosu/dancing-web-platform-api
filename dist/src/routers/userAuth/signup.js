...
router.post("/api/auth/signup", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!lastName || !firstName || !email || !password)
        return next(new Error("Input is not valid! ( lastName, firstName , email, password are required!)"));
    ...
    yield newUser.save();
    req.session = {
        jwt: jsonwebtoken_1.default.sign({ email, userId: newUser._id, role: "user" }, process.env.JWT_KEY),
    };
